...
import BithdayCal from './BithdayCal';

import InputCompont from './InputCompont';
	...
	render(){
		return (
			<div>
				...
				<div id="work-area" className="app__content">
					<BithdayCal appData = {this.state} />
					<InputCompont appData = {this.state} onDateSubmit = {this.onDateSubmit.bind(this)}/>
				</div>
			</div>
		)
	}
